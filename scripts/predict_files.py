# python predict.py --weights data/ownset/save.ckpt-40000 --predict data/ownset/predict_boxes.json
...
def get_results(args, H):
    ...
    with tf.Session() as sess:
        ...
        true_annolist = al.parse(args.predict)
        ...
        for i in range(len(true_annolist)):
            ...
            new_img, rects = add_rectangles(H, [img], np_pred_confidences, np_pred_boxes,
                                            use_stitching=True, rnn_len=H['rnn_len'], min_conf=H['min_conf'], tau=H['tau'], show_suppressed=args.show_suppressed)
